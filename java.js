 ...
 */
 ...
 var vcard = {
    ...
    add_social: function() {
      var LinkedIn = vcard.get_field("linkedin"),
        twitter = vcard.get_field("twitter"),
        youtube = vcard.get_field("youtube"),
        skype = vcard.get_field("linkedin"),
        flickr = vcard.get_field("flickr");
  
      if (LinkedIn !== 'http://www.facebook.com/') {
        vcard.str_vcard += '\nsocialProfile;type=linkedin:' + LinkedIn;
      }
  ...
  $(function() {
    $('input[name="submit"]').click(vcard.save);
      $('input[name="saveFromSondos"]').click(vcard.save);
